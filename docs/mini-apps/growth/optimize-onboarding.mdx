...
- Keep users in-app with [SDK actions for links](/mini-apps/technical-guides/links); avoid fragile static urls
...
- Trigger Sign In with Farcaster (SIWF) / Quick Auth only when needed per [Authentication](/mini-apps/core-concepts/authentication)
...
- After success, prompt social actions via [SDK actions](/mini-apps/technical-guides/links) and [Sharing & Social Graph](/mini-apps/technical-guides/sharing-and-social-graph)
- Offer next step: save, follow, or share — optimize with [Search & Discovery](/mini-apps/technical-guides/search-and-discovery)
</Step>
</Steps>
...
Read more in [Authentication](/mini-apps/core-concepts/authentication).
...
Learn how to implement them with [SDK actions](/mini-apps/technical-guides/links).
...
<CardGroup cols={3}>
  <Card title="Authentication" icon="key" href="/mini-apps/core-concepts/authentication" />
  <Card title="Links & SDK Actions" icon="link" href="/mini-apps/technical-guides/links" />
  <Card title="Search & Discovery" icon="magnifying-glass" href="/mini-apps/technical-guides/search-and-discovery" />
</CardGroup>

<CardGroup cols={3}>
  <Card title="Sharing & Social Graph" icon="share" href="/mini-apps/techincal-guides/sharing-and-social-graph" />
