...
### Authentication
Avoid asking users to re-authenticate. Instead, use the account they’ve already connected to Base App to ensure a seamless experience. Learn more [here](/mini-apps/core-concepts/authentication).
