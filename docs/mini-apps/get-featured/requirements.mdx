...
In order to be eligible for featured placement, your app must meet the requirements outlined in this document. Meeting these requirements doesn't guarantee featured placement, placement is at the discretion of the Base team.
